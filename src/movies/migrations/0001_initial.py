    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='указать суммму в долларах', verbose_name='Бюджет')),
                ...
                ('direcrots', models.ManyToManyField(related_name='film_director', to='movies.actor', verbose_name='режиссёр')),
